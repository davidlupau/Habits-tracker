...
class analysis:
    ...
    def display_longest_streak_all_habits(self):
        ...
        longest_streak = get_longest_streak_all_habits(self.db)

        # Get the habit details
        habit_id = longest_streak[0]
        habit_details = get_habit_details(habit_id)
    ...
    def display_longest_streak_one_habit(self, habit_id):
        ...
        The information is then displayed to the user."""
        streak = get_longest_streak_one_habit(habit_id)
    ...
    def display_demo_tracking(self):
